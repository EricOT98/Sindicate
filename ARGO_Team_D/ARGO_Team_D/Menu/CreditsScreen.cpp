...
CreditScreen::CreditScreen(float width, float height, Game & game, SDL_Renderer * renderer, SDL_Window * window): Screen()
{
	...
	m_labels.push_back(new Label("Credits", m_width / 2.70, 0, 200, 100, SDL_Color{ 200, 0, 0, 255 }, rend, this->window));
	m_labels.push_back(new Label("Made by Michael", m_width / 2.90, 200, 350, 100, SDL_Color{ 200, 0, 0, 255 }, rend, this->window));
