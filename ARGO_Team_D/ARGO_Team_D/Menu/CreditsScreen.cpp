...
CreditScreen::CreditScreen(float width, float height, Game & game, SDL_Renderer * renderer, SDL_Window * window): Screen()
{
	...
	m_labels.push_back(new Label("Developed by Michael Bridgette, Liam Hickey, Eric O'Toole and Dylan Murphy", m_width / 16, 300, 1700, 100, SDL_Color{ 200, 0, 0, 255 }, rend, this->window));
	m_labels.push_back(new Label("Art provided by Billie Jean Doheny and Angela Young", m_width / 4, 500, 1000, 100, SDL_Color{ 200, 0, 0, 255 }, rend, this->window));
